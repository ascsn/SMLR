...
def validate_paper_beta_data(data_dir: str | Path = "beta_decay_data_Ni_80", nucnam: str = "Ni_80") -> ValidationReport:
    """Validate the paper beta-decay strength files used by the Ni-80 examples."""
...
def validate_paper_dipole_data(strength_dir: str | Path = "dipoles_data_all/total_strength") -> ValidationReport:
    """Validate the paper dipole strength files used by the dipole examples."""
