...
'''
Contents: matrix/vector/width construction.

Maybe a new predict_eigensystem or predict_modes?
build_model_matrices_and_vectors is stuffed...
1. unpacks parameters
2. computes shifts
3. computes features
4. builds matrices
5. build vectors
