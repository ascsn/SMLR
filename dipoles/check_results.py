...
idx = 242 #60 looks terrible

helper.plot_Lorentzian_for_idx(idx, train_set, n, params)

emu_alphaD, alphaD_train, times = helper.plot_alphaD(train_set, params, n) #does not need idx as positional argument?
