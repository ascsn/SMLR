...
def parse_args():
    ...
    p.add_argument("--save-dir",     type=str,   default="Beta_decay_package/runs_em2", help="Output directory for run artifacts")
...
def main():
    ...
    # Save parameters with the run artifacts.
    np.savetxt(os.path.join(SAVE_DIR, f'params_{n}_only_HL.txt'), global_best_params)
